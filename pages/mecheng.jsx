    ...
    <div >
      ...
      <div className="our-mission">
        <div className="our-mission-container">
          <div className="our-mission-title">Mechanical/Electrical Team Goal</div>
        ...
        <div className="display-flex">
          <div className={"flex-1"}> 
            ...
            <div className="margin-sm">
              <div className="roboto-bold">Project Manager</div>
              <div className="engineer-text">B.S. Mechanical Engineering, 2022</div>
              <div className="engineer-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Et elit et mauris, mattis dolor praesent nisi, varius orci. Eget pretium, pellentesque nunc montes, pulvinar.</div>
